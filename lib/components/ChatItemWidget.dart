  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onLongPress: !widget.data!.isMe!
          ? null
          : () async {
              bool? res = await showConfirmDialog(context, 'Delete Message', buttonColor: context.scaffoldBackgroundColor);
              if (res ?? false) {
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: widget.data!.isMe.validate() ? radiusOnly(bottomLeft: 12, topLeft: 12, bottomRight: 0, topRight: 12) : radiusOnly(bottomLeft: 0, topLeft: 12, bottomRight: 12, topRight: 12),
              ),
