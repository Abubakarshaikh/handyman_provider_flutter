...
import 'package:handyman_provider_flutter/chatServices/ChatMessagesService.dart';
import 'package:handyman_provider_flutter/chatServices/UserServices.dart';
import 'package:handyman_provider_flutter/components/ChatItemWidget.dart';
import 'package:handyman_provider_flutter/models/ChatMessageModel.dart';
import 'package:handyman_provider_flutter/models/FileModel.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  UserData sender = UserData(
    displayName: getStringAsync(USERNAME),
    profileImage: getStringAsync(PROFILE_IMAGE),
              ...
              return Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(data.displayName!, style: TextStyle(color: whiteColor)),
                    ],
