      ...
      body: Observer(
        builder: (_) => Stack(
          children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(border: Border.all(color: viewLineColor, width: 1), borderRadius: BorderRadius.circular(5)),
                        child: DropdownButtonFormField<Documents>(
                          ...
                          items: documents.map((Documents e) {
                            return DropdownMenuItem<Documents>(value: e, child: Text(e.name!, style: primaryTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis));
                          }).toList(),
                      ...
                      itemBuilder: (context, index) {
                        return providerDocuments[index].providerDocument!.contains('.pdf')
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          padding: EdgeInsets.all(6),
                                          decoration: boxDecorationWithRoundedCorners(backgroundColor: Colors.white.withOpacity(0.5)),
                                          child: Icon(Icons.delete_forever, color: Colors.red, size: 20),
                                        ).onTap(() {
                                          deleteDoc(providerDocuments[index].id);
                                        }).visible(providerDocuments[index].isVerified == 0),
                                        Icon(MaterialIcons.verified_user, color: Colors.green).visible(providerDocuments[index].isVerified == 1),
                                      ],
                                    ),
                                  ],
                                ),
                            ...
                            : Stack(
                                alignment: Alignment.bottomCenter,
                                children: [
                                  cachedImage(providerDocuments[index].providerDocument, height: 200, width: context.width(), fit: BoxFit.cover).cornerRadiusWithClipRRect(8),
                                  Container(
                                    padding: EdgeInsets.all(8),
                                    alignment: Alignment.bottomCenter,
                                    height: 200,
            ...
            noDataFound().center().visible(!appStore.isLoading && documents.isEmpty && providerDocuments.isEmpty),
